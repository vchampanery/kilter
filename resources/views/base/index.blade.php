    ...
    <main class="page-wrapper">
      ...
      <section class="bg-dark dark-mode position-relative min-vh-100 overflow-hidden pt-5">
        ...
        <div class="container position-relative zindex-5 text-center pt-5 mt-lg-4 mt-xl-5">
          ...
          <p class="fs-xl mb-5">And you will find everything you need to build a great looking website</p><a class="scroll-down-btn" href="#landings" data-scroll data-scroll-offset="20">
            <div class="mouse"></div>
            <p>Landings</p></a>
        </div>
        ...
        <div class="parallax mx-auto mb-n5" style="max-width: 1606px;">
          <div class="parallax-layer" data-depth="-0.1"><img src="{{asset('assets1/img/landing/intro/hero/01.png')}}" alt="Background shapes"></div>
          <div class="parallax-layer zindex-2" data-depth="0.12"><img src="{{asset('assets1/img/landing/intro/hero/02.png')}}" alt="Foreground shape"></div>
          <div class="parallax-layer zindex-2" data-depth="0.35"><img src="{{asset('assets1/img/landing/intro/hero/03.png')}}" alt="Foreground shape"></div>
          <div class="parallax-layer zindex-2" data-depth="0.23"><img src="{{asset('assets1/img/landing/intro/hero/04.png')}}" alt="Foreground shape"></div>
        </div>
      </section>
      <!-- Landings-->
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gy-5 pb-xl-3">
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/mobile-app-showcase-light.jpg')}}" alt="Mobile App Showcase"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/mobile-app-showcase-dark.jpg')}}" alt="Mobile App Showcase"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/product-landing-light.jpg')}}" alt="Product Landing"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/product-landing-dark.jpg')}}" alt="Product Landing"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/saas-v1-light.jpg')}}" alt="SaaS v.1"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/saas-v1-dark.jpg')}}" alt="SaaS v.1"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/saas-v2-light.jpg')}}" alt="SaaS v.2"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/saas-v2-dark.jpg')}}" alt="SaaS v.2"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;"><span class="badge bg-danger rouded-pill position-absolute top-0 end-0 translate-middle-y me-n2 zindex-2">New</span>
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/saas-v3-light.jpg')}}" alt="SaaS v.3"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/saas-v3-dark.jpg')}}" alt="SaaS v.3"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/shop-homepage-light.jpg')}}" alt="Shop Homepage"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/shop-homepage-dark.jpg')}}" alt="Shop Homepage"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/marketing-agency-light.jpg')}}" alt="Marketing Agency"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/marketing-agency-dark.jpg')}}" alt="Marketing Agency"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/creative-agency-light.jpg')}}" alt="Creative Agency"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/creative-agency-dark.jpg')}}" alt="Creative Agency"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;"><span class="badge bg-danger rouded-pill position-absolute top-0 end-0 translate-middle-y me-n2 zindex-2">New</span>
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/conference-light.jpg')}}" alt="Conference"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/conference-dark.jpg')}}" alt="Conference"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;"><span class="badge bg-danger rouded-pill position-absolute top-0 end-0 translate-middle-y me-n2 zindex-2">New</span>
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/influencer-light.jpg')}}" alt="Influencer"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/influencer-dark.jpg')}}" alt="Influencer"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/business-consulting-light.jpg')}}" alt="Business Consulting"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/business-consulting-dark.jpg')}}" alt="Business Consulting"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/corporate-light.jpg')}}" alt="Corporate"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/corporate-dark.jpg')}}" alt="Corporate"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/coworking-space-light.jpg')}}" alt="Coworking Space"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/coworking-space-dark.jpg')}}" alt="Coworking Space"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/yoga-studio-light.jpg')}}" alt="Yoga Studio"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/yoga-studio-dark.jpg')}}" alt="Yoga Studio"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/web-studio-light.jpg')}}" alt="Web Studio"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/web-studio-dark.jpg')}}" alt="Web Studio"></div>
            ...
            <div class="col">
              <div class="card-hover card-lifted mx-auto" style="max-width: 416px;">
                <div class="card-lifted overflow-hidden rounded-3 mb-3"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/landings/blog-homepage-light.jpg')}}" alt="Blog Homepage"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/landings/blog-homepage-dark.jpg')}}" alt="Blog Homepage"></div>
              ...
              <div class="card border-0 bg-transparent h-100">
                <div class="card-body d-flex justify-content-center align-items-center border-dashed border-2 rounded-3 py-5 mb-3">
                  <div class="py-5" style="width: 5.5rem;">
                    <lottie-player class="d-dark-mode-none" src="{{asset('assets1/json/animation-sandwatch-light.json')}}" background="transparent" speed="1" loop autoplay></lottie-player>
                    <lottie-player class="d-none d-dark-mode-block" src="{{asset('assets1/json/animation-sandwatch-dark.json')}}" background="transparent" speed="1" loop autoplay></lottie-player>
                  </div>
                </div>
      ...
      <section class="overflow-hidden pt-2 pt-sm-3 pt-md-4 pt-lg-3 pb-1 pb-sm-3 pb-md-4 pb-lg-5">
        <div class="container position-relative py-5 my-lg-3 my-xl-4 my-xxl-5">
          ...
          <div class="d-flex position-relative zindex-2 mb-3">
            <div class="flex-xxl-shrink-0 position-relative zindex-2" style="max-width: 540px; margin-top: 26%; margin-right: -9.6%;" data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" data-disable-parallax-down="lg"><img class="rounded-3 mt-n5 mt-lg-0 d-block d-dark-mode-none" src="{{asset('assets1/img/landing/intro/pages/01-light.jpg')}}" alt="Page" style="box-shadow: 1.875rem .625rem 5rem rgba(65,81,98, .2);"><img class="border rounded-3 mt-n5 mt-lg-0 d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/pages/01-dark.jpg')}}" alt="Page" style="box-shadow: 1.875rem .625rem 5rem rgba(0,0,0, .2);"></div>
            <div class="flex-xxl-shrink-0 position-relative zindex-1" style="max-width: 481px; margin-top: 17.6%; margin-right: -8.5%;" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200" data-disable-parallax-down="lg"><img class="rounded-3 mt-n5 mt-lg-0 d-block d-dark-mode-none" src="{{asset('assets1/img/landing/intro/pages/02-light.jpg')}}" alt="Page" style="box-shadow: 1.875rem .625rem 5rem rgba(65,81,98, .2);"><img class="border rounded-3 mt-n5 mt-lg-0 d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/pages/02-dark.jpg')}}" alt="Page" style="box-shadow: 1.875rem .625rem 5rem rgba(0,0,0, .2);"></div>
            <div class="flex-xxl-shrink-0" style="max-width: 510px;" data-aos="fade-up" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="lg"><img class="rounded-3 d-block d-dark-mode-none" src="{{asset('assets1/img/landing/intro/pages/03-light.jpg')}}" alt="Page" style="box-shadow: 1.875rem .625rem 5rem rgba(65,81,98, .2);"><img class="border rounded-3 d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/pages/03-dark.jpg')}}" alt="Page" style="box-shadow: 1.875rem .625rem 5rem rgba(0,0,0, .2);"></div>
          </div>
        </div>
      </section>
          ...
          <div class="mx-md-n5 mx-xl-0">
            <div class="mx-n4 mx-sm-n5 mx-xl-0">
              <div class="mx-n5 mx-xl-0">
                <img-comparison-slider class="mx-n5 mx-xl-0"><img slot="first" src="{{asset('assets1/img/landing/intro/dark-mode.jpg')}}" alt="Dak Mode"><img slot="second" src="{{asset('assets1/img/landing/intro/light-mode.jpg')}}" alt="Light Mode">
      ...
      <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        ...
        <div class="row align-items-center py-4 mt-2 mt-sm-3 mt-md-4 mb-2 mb-md-3 mb-lg-4" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
          <div class="col-md-6 col-lg-7 order-md-2 d-flex justify-content-end"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/customizer/colors-light.svg')}}" width="593" alt="Colors"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/customizer/colors-dark.svg')}}" width="593" alt="Colors"></div>
        ...
        <div class="row align-items-center py-4 my-2 my-md-3 my-lg-4" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
          <div class="col-md-6 col-lg-7"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/customizer/typography-light.svg')}}" width="636" alt="Typography"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/customizer/typography-dark.svg')}}" width="636" alt="Typography"></div>
        ...
        <!-- Borders-->
        <div class="row align-items-center py-4 my-2 my-md-3 my-lg-4" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
          <div class="col-md-6 col-lg-7 order-md-2 d-flex justify-content-end pb-2 pb-md-0 mb-4 mb-md-0"><img class="d-dark-mode-none" src="{{asset('assets1/img/landing/intro/customizer/borders-light.svg')}}" width="636" alt="Borders"><img class="d-none d-dark-mode-block" src="{{asset('assets1/img/landing/intro/customizer/borders-dark.svg')}}" width="636" alt="Borders"></div>
      ...
      <section class="container py-5 mt-n4 mt-sm-n3 mt-md-0 my-lg-3 my-xl-4 my-xxl-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gy-4 gy-sm-5 pb-md-4 pb-lg-5 mb-2 mb-lg-0 mb-xxl-2">
          ...
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="pe-md-3 pe-lg-3 pe-xl-5"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/bootstrap.png')}}" width="56" alt="Bootstrap">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="ps-md-3 px-lg-2 px-xl-4"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/sass.png')}}" width="56" alt="Sass">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="pe-md-3 ps-lg-3 ps-xl-5"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/gulp.png')}}" width="56" alt="Gulp">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="ps-md-3 pe-lg-3 pe-xl-5"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/pug.png')}}" width="56" alt="Pug">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="pe-md-3 px-lg-2 px-xl-4"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/js.png')}}" width="56" alt="JavaScript">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="ps-md-3 ps-lg-3 ps-xl-5"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/html5.png')}}" width="56" alt="HTML5">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="pe-md-3 pe-lg-3 pe-xl-5"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/touch.png')}}" width="56" alt="Touch support">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="ps-md-3 px-lg-2 px-xl-4"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/google-fonts.png')}}" width="56" alt="Google Fonts">
          ...
          <!-- Item-->
          <div class="col text-center text-sm-start pt-2 pt-sm-0">
            <div class="pe-md-3 ps-lg-3 ps-xl-5"><img class="d-inline-block mb-3 mb-lg-4" src="{{asset('assets1/img/landing/intro/features/vector.png')}}" width="56" alt="Vector icons">
